...
return [
    ...
    */
    'cas_hostname'        => env('CAS_HOSTNAME', 'auth.mlouma.com'),
    ...
    */
    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'auth.mlouma.com'),
    ...
    */
    ...
    | CAS Validation
    |--------------------------------------------------------------------------
    | CAS server SSL validation: 'self' for sesigned certificate, 'ca' for
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://auth.mlouma.com/cas/logout'),
    ...
    */
    'cas_logout_redirect' => env('CAS_LOGOUT_REDIRECT', 'https://auth.mlouma.com/cas/logout'),
    ...
    */
    ...
    | this feature, you may be able to retrieve user meta data.n
    |--------------------------------------------------------------------------
    */
